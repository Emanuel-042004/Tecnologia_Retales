  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control shadow" id="serial" name="serial" step="0.01" value="{{$equipo->serial}}">
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control shadow" id="direccionIP" name="direccionIP" value="{{$equipo->direccionIP}}">
      </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control shadow" id="cantidad_ram" name="cantidad_ram" value="{{$equipo->cantidad_ram}}">
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control shadow" id="cantidad_alma" name="cantidad_alma" value="{{$equipo->cantidad_alma}}">
      </div>
    </div>
  ...
  <div class="mb-3">
    ...
    <div class="col-md-6">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control shadow" id="version_procesador" name="version_procesador" value="{{$equipo->version_procesador}}">
        </div>
        </div>
      <div class="mb-3">
        <label for="modelo_procesador" class="form-label">Modelo de Procesador</label>
        <input type="text" class="form-control shadow" id="modelo_procesador" name="modelo_procesador" value="{{$equipo->modelo_procesador}}">
      </div>
      <div class="mb-3">
        <label for="gen_procesador" class="form-label">Generación de Procesador</label>
        <input type="text" class="form-control shadow" id="gen_procesador" name="gen_procesador" value="{{$equipo->gen_procesador}}">
      </div>
      <div class="mb-3">
        <label for="tarjeta_grafica" class="form-label">Tarjeta Gráfica</label>
        <input type="text" class="form-control shadow" id="tarjeta_grafica" name="tarjeta_grafica" value="{{$equipo->tarjeta_grafica}}">
      </div>
    </div>
  </div>
